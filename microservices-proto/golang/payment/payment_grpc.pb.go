...
var Payment_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "microservices/order/proto/payment.proto",
}

const (
	OrderService_PlaceOrder_FullMethodName = "/payment.OrderService/PlaceOrder"
)
...
func (c *orderServiceClient) PlaceOrder(ctx context.Context, in *CreateOrderRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedOrderServiceServer) PlaceOrder(context.Context, *CreateOrderRequest) (*CreateOrderResponse, error) {
...
func _OrderService_PlaceOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).PlaceOrder(ctx, req.(*CreateOrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
