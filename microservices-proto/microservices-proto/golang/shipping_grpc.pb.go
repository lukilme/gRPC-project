...
const (
	ShippingService_CalculateShipping_FullMethodName = "/shipping.ShippingService/CalculateShipping"
)
...
type ShippingServiceClient interface {
	CalculateShipping(ctx context.Context, in *ShippingRequest, opts ...grpc.CallOption) (*ShippingResponse, error)
}
...
func (c *shippingServiceClient) CalculateShipping(ctx context.Context, in *ShippingRequest, opts ...grpc.CallOption) (*ShippingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShippingResponse)
	err := c.cc.Invoke(ctx, ShippingService_CalculateShipping_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShippingServiceServer interface {
	CalculateShipping(context.Context, *ShippingRequest) (*ShippingResponse, error)
...
func (UnimplementedShippingServiceServer) CalculateShipping(context.Context, *ShippingRequest) (*ShippingResponse, error) {
...
func _ShippingService_CalculateShipping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShippingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingServiceServer).CalculateShipping(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShippingService_CalculateShipping_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServiceServer).CalculateShipping(ctx, req.(*ShippingRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ShippingService_CalculateShipping_Handler,
		},
	},
